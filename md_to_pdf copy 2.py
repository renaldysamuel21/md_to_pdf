...
def md_to_pdf(input_md, output_pdf):
    ...
    # Gunakan BeautifulSoup untuk modifikasi heading
    soup = BeautifulSoup(html_content, "html.parser")
    for h2 in soup.find_all("h2"):
        if "Bab 1" not in h2.get_text():  # tambahkan page break kecuali Bab 1
            h2["style"] = (h2.get("style") or "") + "page-break-before: always;"
    ...
    <head>
      ...
      <style>
        ...
        body {{
          ...
          font-size: 13pt;
          line-height: 1.5;
          margin: 0; /* margin body nol, kita pakai @page */
        }}
        h1 {{
          font-size: 22pt;
          text-align: center;
    ...
    # Opsi wkhtmltopdf – paksa margin 2.54 cm & nomor halaman
    options = {
        'margin-top': '25.4mm',
